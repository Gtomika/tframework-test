...
public class ProfilesTestConfigApplierTest {
    ...
    private ProfilesTestConfigApplier applier;

    @BeforeEach
    void setUp() {
        applier = new ProfilesTestConfigApplier(systemPropertyHelper, EXTENSION_NAME);
    }
